...
namespace utils {
    // neighbour checking
        ...
        void addTopFace(std::vector<Vertex>& v, int x, int z, int y) {
        ...
        void addBottomFace(std::vector<Vertex>& v, int x, int z, int y) {
            glm::vec3 normal = glm::vec3(0, -1, 0);
        ...
        void addRightFace(std::vector<Vertex>& v, int x, int z, int y) {
        ...
        void addLeftFace(std::vector<Vertex>& v, int x, int z, int y) {
            glm::vec3 normal = glm::vec3(-1, 0, 0);
        ...
        void addFrontFace(std::vector<Vertex>& v, int x, int z, int y) {
        ...
        void addBackFace(std::vector<Vertex>& v, int x, int z, int y) {
            glm::vec3 normal = glm::vec3(0, 0, -1);
